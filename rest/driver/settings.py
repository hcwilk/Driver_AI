...
SECRET_KEY = 'django-insecure-vu^izv1035j*&_(-=4-#dp=h9l0!aofgej9+28apb)v9+e#m98'
...
ALLOWED_HOSTS = [
    ...
    '0275-104-182-30-97.ngrok-free.app'
]
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'driver.quickstart',  # Updated to 'driver.quickstart'
